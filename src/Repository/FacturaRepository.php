...
class FacturaRepository extends ServiceEntityRepository
{
    ...
    public function obtenerAllFacturas(){
        return $this->getEntityManager()
            ->createQuery('
                SELECT factura.id, factura.fec_factura, factura.cliente_id, factura.usuario_id, factura.total, usuario.email
                FROM App:Factura AS factura
                JOIN factura.usuario AS usuario
                JOIN factura.cliente AS cliente
            ');
    }
